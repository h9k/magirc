...
{if $cfg->net_roundrobin}
	...
	{if $cfg->net_port_ssl} <a href="ircs://{$cfg->net_roundrobin}:{$cfg->net_port_ssl}"><img src="theme/{$cfg->theme}/img/icons/ssl.png" alt="ssl" title="{t}Secure connection{/t}" /></a>{/if}
	<br /><br />
{/if}
