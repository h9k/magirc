...
<div id="footer">powered by <a href="http://www.magirc.org/">MagIRC</a> v{$smarty.const.VERSION_FULL}-{$cfg->service}</div>
{/block}
{block name="js"}
{if $cfg->cdn_enable}
...
<script type="text/javascript" src="//ajax.aspnetcdn.com/ajax/jquery.dataTables/1.10.9/jquery.dataTables.js"></script>
{else}
