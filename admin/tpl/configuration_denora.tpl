...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
	<tr>
		...
		<td align="left"><input name="username" type="text" id="username" value="{$db.username}" size="32" maxlength="1024" /></td>
	</tr>
	<tr>
		<td align="right">Password</td>
		<td align="left"><input type="password" name="password" id="password" value="{$db.password}" size="32" maxlength="1024" /></td>
	</tr>
	<tr>
		<td align="right">Database Name</td>
		<td align="left"><input type="text" name="database" id="database" value="{$db.database}" size="32" maxlength="1024" /></td>
	</tr>
	<tr>
		<td align="right">Hostname</td>
		<td align="left"><input type="text" name="hostname" id="hostname" value="{$db.hostname}" size="32" maxlength="1024" /></td>
	</tr>
	<tr>
		<td align="right">TCP Port</td>
		<td align="left"><input type="text" name="port" id="port" value="{$db.port}" size="32" maxlength="1024" /></td>
	</tr>
</table>
